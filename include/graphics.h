...
extern const u32 gMonFrontPic_Aureon[];
extern const u32 gMonPalette_Aureon[];
extern const u32 gMonBackPic_Aureon[];
extern const u32 gMonShinyPalette_Aureon[];
extern const u32 gMonStillFrontPic_Aureon[];
extern const u8 gMonIcon_Aureon[];
extern const u8 gMonFootprint_Aureon[];
extern const u32 gMonFrontPic_Empyreon[];
extern const u32 gMonPalette_Empyreon[];
extern const u32 gMonBackPic_Empyreon[];
extern const u32 gMonShinyPalette_Empyreon[];
extern const u32 gMonStillFrontPic_Empyreon[];
extern const u8 gMonIcon_Empyreon[];
extern const u8 gMonFootprint_Empyreon[];
extern const u32 gMonFrontPic_EmpyreonMn[];
extern const u32 gMonPalette_EmpyreonMn[];
extern const u32 gMonBackPic_EmpyreonMn[];
extern const u32 gMonShinyPalette_EmpyreonMn[];
extern const u32 gMonStillFrontPic_EmpyreonMn[];
extern const u8 gMonIcon_EmpyreonMn[];
extern const u8 gMonFootprint_EmpyreonMn[];
