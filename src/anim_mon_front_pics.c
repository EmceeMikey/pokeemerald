...
const u32 gMonFrontPic_Aureon[] = INCBIN_U32("graphics/pokemon/aureon/anim_front.4bpp.lz");
const u32 gMonFrontPic_Empyreon[] = INCBIN_U32("graphics/pokemon/empyreon/anim_front.4bpp.lz");
const u32 gMonFrontPic_EmpyreonMn[] = INCBIN_U32("graphics/pokemon/empyreonmn/anim_front.4bpp.lz");
