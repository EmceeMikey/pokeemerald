...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        .types = { TYPE_ELECTRIC, TYPE_AURAL },
        .catchRate = 190,
        .expYield = 103,
        .evYield_HP        = 0,
        .evYield_Attack    = 0,
