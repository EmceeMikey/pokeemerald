...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_GLACEON]     = { .size = 0x88, .y_offset =  0 },
    [SPECIES_LEAFEON]     = { .size = 0x88, .y_offset = 0 },
    [SPECIES_SYLVEON]     = { .size = 0x88, .y_offset = 0 },
    [SPECIES_AUREON]      = { .size = 0x88, .y_offset = 0 },
    [SPECIES_EMPYREON]    = { .size = 0x88, .y_offset = 0 },
    [SPECIES_EMPYREON_MN] = { .size = 0x88, .y_offset = 0 },
