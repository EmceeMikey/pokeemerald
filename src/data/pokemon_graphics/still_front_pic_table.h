...
// Gen III
    ...
    SPECIES_SPRITE(AUREON,        gMonStillFrontPic_Aureon),
    SPECIES_SPRITE(EMPYREON,      gMonStillFrontPic_Empyreon),
    SPECIES_SPRITE(EMPYREON_MN,   gMonStillFrontPic_EmpyreonMn),
