...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_LEAFEON]     = { .size = 0x78, .y_offset =  6 },
    [SPECIES_SYLVEON]     = { .size = 0x78, .y_offset =  6 },
    [SPECIES_AUREON]      = { .size = 0x78, .y_offset =  6 },
    [SPECIES_EMPYREON]    = { .size = 0x78, .y_offset =  6 },
    [SPECIES_EMPYREON_MN] = { .size = 0x78, .y_offset =  6 },
