const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(AUREON, gMonShinyPalette_Aureon),
    SPECIES_SHINY_PAL(EMPYREON, gMonShinyPalette_Empyreon),
    SPECIES_SHINY_PAL(EMPYREON_MN, gMonShinyPalette_EmpyreonMn),
