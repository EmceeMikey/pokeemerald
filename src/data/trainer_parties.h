...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_PROTECT, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND, MOVE_THUNDERBOLT}
    },
    {
    .iv = 250,
    .lvl = 39,
    .species = SPECIES_EXPLOUD,
    .moves = {MOVE_PROTECT, MOVE_STOMP, MOVE_SUPERSONIC, MOVE_BOOMBURST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOLLOW_ME, MOVE_ICY_WIND, MOVE_PROTECT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METEOR_BEAM, MOVE_PROTECT, MOVE_SURF, MOVE_REFLECT}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PROTECT, MOVE_MOONBLAST, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EXPLOSION, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Aubrey[] = {
    ...
    .moves = {MOVE_REFLECT, MOVE_SWIFT, MOVE_LIGHT_SCREEN, MOVE_DRAINING_KISS}
    },
    {
    .iv = 250,
    .lvl = 8,
