...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_GLACEON]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_LEAFEON]    = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_SYLVEON]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_AUREON]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_EMPYREON]   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_EMPYREON_MN]= BACK_ANIM_SHRINK_GROW_VIBRATE,
};
