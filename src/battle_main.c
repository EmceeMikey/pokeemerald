...
const u8 gTypeEffectiveness[513] =
{
    ...
    TYPE_AURAL, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AURAL, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AURAL, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AURAL, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AURAL, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AURAL, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AURAL, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AURAL, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AURAL, TYPE_AURAL, TYPE_MUL_NO_EFFECT,
    TYPE_ELECTRIC, TYPE_AURAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ICE, TYPE_AURAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_AURAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_AURAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DARK, TYPE_AURAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FLYING, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_ASTRAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_ASTRAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAIRY, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_DARK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FORESIGHT, TYPE_FORESIGHT, TYPE_MUL_NO_EFFECT,
    TYPE_NORMAL, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_FIGHTING, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_DRUM_BEATING, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DRUM_BEATING, TYPE_AURAL, TYPE_MUL_NO_EFFECT,
    TYPE_TORCH_SONG, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_TORCH_SONG, TYPE_AURAL, TYPE_MUL_NO_EFFECT,
    TYPE_SPARKLING_ARIA, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SPARKLING_ARIA, TYPE_AURAL, TYPE_MUL_NO_EFFECT,
...
const u8 gTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 1] =
{
    ...
    [TYPE_DRUM_BEATING] = _("GRASS"),
    [TYPE_TORCH_SONG] = _("FIRE"),
    [TYPE_SPARKLING_ARIA] = _("WATER"),
};
